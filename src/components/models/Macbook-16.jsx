...
Files: macbook-16.glb [639.28KB] > /Users/vania/Desktop/juan/dev/apple-page/apple-page/public/models/macbook-16-transformed.glb [629.72KB] (1%)
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        ...
        if (!noChangeParts.includes(child.name) && child.material && child.material.color) {
